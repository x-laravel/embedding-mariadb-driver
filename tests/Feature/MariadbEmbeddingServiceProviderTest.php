...
use XLaravel\Embedding\Driver\Mariadb\MariadbPayloadStoreMetrics;
...
class MariadbEmbeddingServiceProviderTest extends TestCase
{
    ...
    public function test_it_binds_mariadb_payload_store_metrics(): void
    {
        $this->assertInstanceOf(MariadbPayloadStoreMetrics::class, app(PayloadStoreMetrics::class));
    }
